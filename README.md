...
def is_safe(grid, row, col, num):
    if num in grid[row]:
        return False
    if num in [grid[r][col] for r in range(M)]:
        return False
    start_row = row - row % 3
    start_col = col - col % 3
    for i in range(3):
...
## Output:
<img width="343" height="220" alt="image" src="https://github.com/user-attachments/assets/4b5863e7-af37-4b7f-8326-35359bad27ec" />
